...
class SandstormWeatherSystem {
  ...
  settings = { ...DEFAULT_SANDSTORM_WEATHER_SETTINGS };
  constructor(options) {
    ...
    this.sandMesh = new THREE.Mesh(createSandstormGeometry(options.seed ?? 1515017997), this.sandMaterial.material);
