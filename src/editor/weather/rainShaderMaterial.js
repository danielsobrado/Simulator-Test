...
function createRainShaderMaterial() {
  const uniforms = {
    ...
    uTopY: { value: 20 },
    uBottomY: { value: -12 },
    uColor: { value: new THREE.Color(12180735) },
    uOpacity: { value: 0.46 }
  };
...
function createSnowShaderMaterial() {
  const uniforms = {
    ...
    uTopY: { value: 18 },
    uBottomY: { value: -8 },
    uColor: { value: new THREE.Color(15857663) },
    uOpacity: { value: 0.76 }
  };
  const material = new THREE.ShaderMaterial({
    uniforms,
...
function createSandstormShaderMaterial() {
  const uniforms = {
    uCenter: { value: new THREE.Vector3() },
    uTime: { value: 0 },
    uIntensity: { value: 1 },
    uWindX: { value: -1.8 },
    uWindZ: { value: 0.24 },
    uColor: { value: new THREE.Color(12162903) },
    uOpacity: { value: 0.84 }
  };
  const material = new THREE.ShaderMaterial({
    uniforms,
...
function createSandstormHazeShaderMaterial() {
  const uniforms = {
    uCenter: { value: new THREE.Vector3() },
    uTime: { value: 0 },
    uIntensity: { value: 1 },
    uWindX: { value: -1.8 },
    uWindZ: { value: 0.24 },
    uColor: { value: new THREE.Color(16768149) },
    uOpacity: { value: 0.11 }
  };
  const material = new THREE.ShaderMaterial({
    uniforms,
...
function createStormShaderMaterial() {
  const uniforms = {
    uTime: { value: 0 },
    uIntensity: { value: 1 },
    uEffectColor: { value: new THREE.Color(0.3, 0.3, 1) },
