...
export function packTreeInstanceMorphology(input) {
...
export function unpackTreeInstanceMorphology(input, offset = 0) {
...
export function packVegetationTreeInstance(input) {
