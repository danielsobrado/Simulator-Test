import { createEditCommand } from "../_clod_shims/edit_commands.js";
function prepareEarthSpellCast(target, config, context) {
  ...
  return {
    ...
    request: {
      ...
      edit: {
        ...
        shape: config.shape,
        op: config.operation,
        material: config.operation === "add" ? config.material : void 0,
...
async function executePreparedEarthSpellCast(prepared, deps) {
