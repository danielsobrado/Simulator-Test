...
export const BUILTIN_WORKSHOP_MATERIAL_PRESETS = Object.freeze({
  ...
  'limestone-masonry': Object.freeze({
    ...
    tint: '#fffaf0', roughness: 0.88, metalness: 0, normalStrength: 0.65, aoStrength: 1,
  ...
  'sandstone-masonry': Object.freeze({
    ...
    tint: '#fff2da', roughness: 0.92, metalness: 0, normalStrength: 0.7, aoStrength: 1,
  ...
  'ochre-plaster': Object.freeze({
    ...
    tint: '#ffe0ad', roughness: 0.96, metalness: 0, normalStrength: 0.25, aoStrength: 1,
  ...
  'lime-plaster': Object.freeze({
    ...
    tint: '#ffffff', roughness: 0.97, metalness: 0, normalStrength: 0.2, aoStrength: 1,
  ...
  'terracotta-tile': Object.freeze({
    ...
    tint: '#ffc0a0', roughness: 0.84, metalness: 0, normalStrength: 0.85, aoStrength: 1,
  ...
  'slate-roof': Object.freeze({
    ...
    tint: '#dce8ed', roughness: 0.8, metalness: 0, normalStrength: 0.7, aoStrength: 1,
  ...
  'aged-timber': Object.freeze({
    ...
    tint: '#ffd9b0', roughness: 0.9, metalness: 0, normalStrength: 0.6, aoStrength: 1,
...
function normalizePreset(presetId, input) {
  ...
  return Object.freeze({
    ...
    aoStrength: number(source.aoStrength, 'Material ambient occlusion strength', 1, 0, 2),
